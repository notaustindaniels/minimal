...
**Auth:** Set your Claude Code OAuth token (get one from https://console.anthropic.com/):
```bash
...
Ensure `CLAUDE_CODE_OAUTH_TOKEN` is exported in your shell environment. Get a token from https://console.anthropic.com/.
